...
const ExporterAndProducer = (document: any) => (
  <div className="row">
    <div className="col-12 col-md-6">
      <div className="p-2" style={borderStyle}>
        ...
        <pre className="p-2">
          ...
          <div>{`${get(document, "exporter.address.city")}, ${get(document, "exporter.address.state")}, ${get(
            document,
            "exporter.address.country"
          )}`}</div>
        </pre>
      </div>
      <div className="p-2" style={borderStyle}>
        ...
        <pre className="p-2">
          ...
          <div>{`${get(document, "producer.address.city")}, ${get(document, "producer.address.state")}, ${get(
            document,
    ...
    <div className="col-12 col-md-6" style={borderStyle}>
      <div className="d-flex flex-column justify-content-between h-100">
        ...
        <div className="p-2">Issued in: {get(document, "issuers[0].address.country")}&nbsp;</div>
      </div>
    </div>
  </div>
);

const Importer = (document: any) => (
  <div className="row">
    <div className="col-12 col-md-6 p-2" style={borderStyle}>
      ...
      <pre className="p-2">
        ...
        <div>{`${get(document, "importer.address.city")}, ${get(document, "importer.address.state")}, ${get(
          document,
...
const TransportAndPort = (document: any) => (
  <div className="row">
    <div className="col-12 col-md-6 p-2" style={borderStyle}>
      ...
      <div className="p-2">
        ...
        <div>
          Vessel/Flight/Train/Vehicle No.: <pre>{get(document, "transport.vehicleNo")}</pre>
        </div>
        <div>
          Port of loading: <pre>{get(document, "transport.loadingPort")}</pre>
        </div>
        <div>
          Port of discharge: <pre>{get(document, "transport.dischargePort")}</pre>
        </div>
      </div>
    </div>
    <div className="col-12 col-md-6 p-2" style={borderStyle}>
...
const LineItems = (item: any, key: any) => {
  return (
...
const ItemsTransported = (document: any) => {
  ...
  return (
    <>
      <div className="row">
        ...
        <div className="col-2 p-2" style={borderStyle}>
          11. Gross or net weight or other quantity (e.g. Quantity Unit, litres, m<sup>3</sup>.)
        </div>
        <div className="col-2 p-2" style={borderStyle}>
...
const Declarations = (document: any) => (
  <div className="row">
    <div className="col-12 col-md-6 p-2" style={borderStyle}>
      <div className="d-flex flex-column justify-content-between h-100">
        <div>13. Decaration by the exporter or producer</div>
        <div className="p-2">
          The undersigned herby declares that the above-stated information is correct and that the goods exported to{" "}
          {get(document, "importer.address.country")} comply with the origin requirements specified in the
          China-Australia Free Trade Agreement.
        </div>
        <div className="p-2">
          <div>
            {`${get(document, "issuers[0].address.city")} ${get(document, "issuers[0].address.country")} ${get(
              document,
              "issuedDate"
            )}`}
          </div>
    ...
    <div className="col-12 col-md-6 p-2" style={borderStyle}>
      ...
      <div className="p-2">
        On the basis of the control carried out, it is hereby certified that the information herein is correct and that
        the described goods comply with the origin requirements of the China-Australia Free Trade Agreement.
      </div>
      <div className="p-2">
        <div>
          {`${get(document, "issuers[0].address.city")} ${get(document, "issuers[0].address.country")} ${get(
      ...
      <div className="p-2 row">
        <div className="col-6">Tel: {get(document, "issuers[0].contact.tel")}</div>
        <div className="col-6">Fax: {get(document, "issuers[0].contact.fax")}</div>
      </div>
      <div className="p-2">
        <div>Address:</div>
        <div>{get(document, "issuers[0].address.street")}</div>
        <div>{`${get(document, "issuers[0].address.city")} ${get(document, "issuers[0].address.state")} ${get(
          document,
